...
static void lvgl_port_touchpad_read(lv_indev_t *indev_drv, lv_indev_data_t *data)
{
    ...
    /* PIAM Pro: si el I2C del tactil falla momentaneamente (comun al
       compartir el bus con AXP2101/RTC/giroscopio), lo tratamos como
       "sin toque" en este ciclo, en vez de tirar abajo todo el sistema
       con ESP_ERROR_CHECK. */
